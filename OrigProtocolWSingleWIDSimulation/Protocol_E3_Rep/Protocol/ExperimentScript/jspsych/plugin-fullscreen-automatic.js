var jsPsychFullscreenAutomatic = (function (jspsych) {
  'use strict';
  ...
  FullscreenAutomaticPlugin.info = info;

  return FullscreenAutomaticPlugin;
